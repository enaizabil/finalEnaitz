...
public class StudentFacadeREST extends AbstractFacade<Student> {
    ...
    public List<Student> searchStudent(@PathParam("fullName") String fullName) throws ReadException {
        List<Student> students = null;
        try {

            students = em.createNamedQuery("searchStudent").setParameter("fullName", fullName).getResultList();
        } catch (Exception e) {
